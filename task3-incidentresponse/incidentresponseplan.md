...
- **Comms Lead (CL):** Posts internal/status-page updates at the cadence above.
...
2. **Declare SEV**, open war room + ticket, assign **TL/CL/Scribe**.
3. **Triage (≤10 min):** scope, start time, last deploy/feature flag, impacted %.
...
## 6) Message templates
**Internal (start):**  
“Declaring **SEV-2**: API latency since 11:20 UTC. Impact: ~25% of users slow checkout. Mitigation: rollback API v1.25→v1.24, check DB. Next update 11:45 UTC. IC: @name, TL: @name, CL: @name. Ticket: INC-1234.”

**Status page (investigating):**  
“We’re investigating elevated API latency affecting some users. Next update at 11:45 UTC.”

**Resolved:**  
“Resolved. 11:20–11:42 UTC API slowness due to faulty deploy; rollback at 11:33 UTC. Metrics normal. Postmortem will follow.”

## 7) SLO/Alert pointers (align with Task-1)
- **Error rate (5xx%)**, **P95/P99 latency**, availability, CPU/mem/disk, container health.
